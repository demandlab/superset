...
builtin_time_grains: dict[str | None, str] = {
    ...
    TimeGrainConstants.QUARTER: _("Calendar Quarter"),
    TimeGrainConstants.YEAR: _("Calendar Year"),
    ...
    TimeGrainConstants.FISCAL_YEAR: _("Fiscal Year"),
    TimeGrainConstants.FISCAL_QUARTER: _("Fiscal Quarter"),
    TimeGrainConstants.FISCAL_MONTH: _("Fiscal Month"),
    TimeGrainConstants.WEEK_IN_YEAR: _("Week in Year"),
    TimeGrainConstants.WEEK_IN_MONTH: _("Week in Month"),
    TimeGrainConstants.DAY_IN_YEAR: _("Day in Year"),
    TimeGrainConstants.DAY_IN_MONTH: _("Day in Month"),
    TimeGrainConstants.DAY_IN_WEEK: _("Day in Week"),
    TimeGrainConstants.DATE_ONLY: _("Date Only"),
    TimeGrainConstants.HOUR_IN_DAY: _("Hour in Day"),
}
